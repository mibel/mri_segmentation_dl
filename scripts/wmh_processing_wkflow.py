...
# Bias correction, FLAIR
bias_correct_flair_fs_nucorrect = ni_engine.Node(ni_fs.MNIBiasCorrection(),
                                             name='bias_correct_flair_fs_nucorrect')
bias_correct_flair_ants_n4 = ni_engine.Node(ni_ants.N4BiasFieldCorrection(),
                                        name='bias_correct_flair_ants_n4')
...
preproc.connect([(infosource, selectfiles, [('site_top', 'site_top'),
                 ...
                 (selectfiles, ants_warp_flair, [('t1', 'reference_image'),
                                           ('flair', 'input_image')]),
                 (ants_warp_flair, bias_correct_flair_ants_n4, [('output_image', 'input_image')]),
                 (bet_t1, bias_correct_flair_ants_n4, [('mask_file', 'mask_image')]),                 
                 (ants_warp_flair, bias_correct_flair_fs_nucorrect, [('output_image', 'in_file')]),
                 (bet_t1, bias_correct_flair_fs_nucorrect, [('mask_file', 'mask')]),                 
                 ...
                 (bias_correct_flair_ants_n4, datasink, [('output_image', 'preproc.@bc_ants_n4_flair')]),
                 (bias_correct_flair_fs_nucorrect, datasink, [('out_file', 'preproc.@bc_nucorrect_flair')]),
